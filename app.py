...
# =====================================================
if role == "Patient":
    st.title("📝 HeyTherapy – Daily Mental Health Check-In")
...
# =====================================================
if role == "Doctor":
    st.title("🏥 HeyTherapy – Doctor Dashboard")
    ...
    if not patients:
        ...
        for pid, pdata in patients.items():
            ...
            overview.append({
                ...
                "Risk": "🔴 High" if last["Score"] <= 2
                        else "🟡 Moderate" if last["Score"] <= 3.5
                        else "🟢 Low"
            })
...
- Do NOT provide treatment advice to the patient.
"""
